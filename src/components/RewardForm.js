...
class RewardForm extends Component {
    ...
    render() {
        return (
            <form className="rewardForm" style={{display: "flex", alignItems: "center", justifyContent: "center"}} >
                <div className="content d-flex justify-content-center pt-5">
                <div className="primary-input" style={{border: "1px solid black", borderRadius: "14px"}}>
                    <div className="mb-3 ps-4 ps-xl-6">
                    <label htmlFor="" className="contact-input">
                        <input type="number"  onChange={this.myChangeHandler}/>
                        <button type="button" className="btn" onClick={()=>this.mySubmitHandler()}>
                        <span>Reward</span>
                        </button>
                    </label>
                    </div>
